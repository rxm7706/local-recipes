...
This recipe builds Apache Tika 3.2.3 for conda-forge. All dependency versions are from `tika-parent-3.2.3.pom` and all SHA256 checksums have been verified directly from Maven Central.
...
├── meta.yaml      # Main recipe (66 source JARs, 2 outputs)
...
The recipe produces 2 conda packages:

1. **apache-tika-app** (3.2.3) - The uber-jar with CLI wrapper
2. **apache-tika** (3.2.3) - Metapackage depending on apache-tika-app
