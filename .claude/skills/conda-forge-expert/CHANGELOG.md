...
**v8.11.2** (Jun 7, 2026, current) — Recipe-authoring gotcha G10 added from the `simonw/micropython-wasm` packaging retro. **PATCH bump**, standalone: one new SKILL.md section + one CHANGELOG observation; no code change. The v8.10 → v8.11.1 npm-generator correction arc summarized below is unchanged.
