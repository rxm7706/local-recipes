#!/usr/bin/env python3
"""
Entrypoint wrapper for conda-forge-expert → pyver_breakdown.py
Stable public CLI surface for pixi tasks and external callers.
Canonical implementation: .claude/skills/conda-forge-expert/scripts/pyver_breakdown.py
...
_SKILL_SCRIPT = (
    ...
    / "skills" / "conda-forge-expert" / "scripts" / "pyver_breakdown.py"
)
