#!/usr/bin/env python3
"""
Entrypoint wrapper for conda-forge-expert → epss_fetcher.py
Stable public CLI surface for pixi tasks and external callers.
Canonical implementation: .claude/skills/conda-forge-expert/scripts/epss_fetcher.py
...
_SKILL_SCRIPT = (
    ...
    / "skills" / "conda-forge-expert" / "scripts" / "epss_fetcher.py"
)
