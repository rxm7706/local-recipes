#!/usr/bin/env python3
"""
Entrypoint wrapper for conda-forge-expert → staleness_report.py
Stable public CLI surface for pixi tasks and external callers.
Canonical implementation: .claude/skills/conda-forge-expert/scripts/staleness_report.py
...
_SKILL_SCRIPT = (
    ...
    / "skills" / "conda-forge-expert" / "scripts" / "staleness_report.py"
)
