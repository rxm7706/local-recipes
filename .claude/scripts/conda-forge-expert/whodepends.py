#!/usr/bin/env python3
"""
Entrypoint wrapper for conda-forge-expert → whodepends.py
Stable public CLI surface for pixi tasks and external callers.
Canonical implementation: .claude/skills/conda-forge-expert/scripts/whodepends.py
...
_SKILL_SCRIPT = (
    ...
    / "skills" / "conda-forge-expert" / "scripts" / "whodepends.py"
)
