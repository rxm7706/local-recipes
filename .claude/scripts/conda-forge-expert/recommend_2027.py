#!/usr/bin/env python3
"""
Entrypoint wrapper for conda-forge-expert → recommend_2027.py
Stable public CLI surface for pixi tasks and external callers.
Canonical implementation: .claude/skills/conda-forge-expert/scripts/recommend_2027.py
...
_SKILL_SCRIPT = (
    ...
    / "skills" / "conda-forge-expert" / "scripts" / "recommend_2027.py"
)
