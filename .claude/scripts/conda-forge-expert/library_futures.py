#!/usr/bin/env python3
"""
Entrypoint wrapper for conda-forge-expert → library_futures.py
Stable public CLI surface for pixi tasks and external callers.
Canonical implementation: .claude/skills/conda-forge-expert/scripts/library_futures.py
...
_SKILL_SCRIPT = (
    ...
    / "skills" / "conda-forge-expert" / "scripts" / "library_futures.py"
)
