#!/usr/bin/env python3
"""
Entrypoint wrapper for conda-forge-expert → pypi_intelligence.py
Stable public CLI surface for pixi tasks and external callers.
Canonical implementation: .claude/skills/conda-forge-expert/scripts/pypi_intelligence.py
...
_SKILL_SCRIPT = (
    ...
    / "skills" / "conda-forge-expert" / "scripts" / "pypi_intelligence.py"
)
