#!/usr/bin/env python3
"""
Entrypoint wrapper for conda-forge-expert → lts_registry_gap.py
Stable public CLI surface for pixi tasks and external callers.
Canonical implementation: .claude/skills/conda-forge-expert/scripts/lts_registry_gap.py
...
_SKILL_SCRIPT = (
    ...
    / "skills" / "conda-forge-expert" / "scripts" / "lts_registry_gap.py"
)
