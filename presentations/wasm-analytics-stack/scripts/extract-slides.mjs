...
// rename this to match (or rename the export to `Wasm Analytics Stack.dc.html`).
const SRC = join(root, 'project', 'Wasm Analytics Stack.dc.html');
...
// add one entry per remote image the wasm-analytics-stack prototype references, then
