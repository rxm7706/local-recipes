...
// rename this to match (or rename the export to `PyForge Genesis.dc.html`).
const SRC = join(root, 'project', 'PyForge Genesis.dc.html');
...
// add one entry per remote image the PyForge-Genesis prototype references, then
