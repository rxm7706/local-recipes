...
`6af4c28d-d510-4e9b-b788-6c0e5d651183`, then read back and SHA-256-compared against disk:

| Artifact | Bytes | Design etag | Read-back |
|---|---|---|---|
| `PyForge Genesis - Infographic.dc.html` | 142,443 | `1789635946881823` | identical ✓ |
| `PyForge Genesis - Infographic Deck.dc.html` | 149,504 | `1789635948765624` | identical ✓ |

Both files are under the 256 KiB `read_file` cap, so a single call plus entity-decoded SHA-256
comparison is the read-back proof (no windowing needed). `deck-facts pyforge-genesis --check`
