...
// rename this to match (or rename the export to `Deckcraft.dc.html`).
const SRC = join(root, 'project', 'Deckcraft.dc.html');
...
// add one entry per remote image the deckcraft prototype references, then
