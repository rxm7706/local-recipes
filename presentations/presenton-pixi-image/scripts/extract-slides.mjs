// Extracts the slides from the Claude Design handoff prototype into
...
// rename this to match (or rename the export to `Presenton Conda-Native.dc.html`).
const SRC = join(root, 'project', 'Presenton Conda-Native.dc.html');
...
// add one entry per remote image the presenton-pixi-image prototype references, then
