...
// rename this to match (or rename the export to `PyForge Atlas.dc.html`).
const SRC = join(root, 'project', 'PyForge Atlas.dc.html');
...
// add one entry per remote image the PyForge-Atlas prototype references, then
