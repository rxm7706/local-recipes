...
const SRC = join(root, 'project', 'Agentic SDLC.dc.html');
const FRAG_DIR = join(root, 'src', 'slides', 'fragments');
const MANIFEST = join(root, 'src', 'slides', 'manifest.json');

// Map the four remote dev.to banners to the locally-bundled copies.
// Relative paths (no leading slash) so banners resolve whether the deck is
// served from the site root, a subpath, or opened as a built file://.
const BANNER_MAP = {
  'https://dev-to-uploads.s3.amazonaws.com/uploads/articles/u0pbo16u36ywgrbym3eb.jpeg':
    'assets/banners/framework.jpeg',
  'https://dev-to-uploads.s3.amazonaws.com/uploads/articles/ih3d75uluo0vuuad29ok.png':
    'assets/banners/phases.png',
  'https://dev-to-uploads.s3.amazonaws.com/uploads/articles/6t0wbftde1briycf653f.png':
    'assets/banners/testing.png',
  'https://dev-to-uploads.s3.amazonaws.com/uploads/articles/kvs7iq8i1o7cij2qg1oe.png':
    'assets/banners/ecosystem.png',
};
