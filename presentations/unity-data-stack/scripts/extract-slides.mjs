...
// rename this to match (or rename the export to `Unity Data Stack.dc.html`).
const SRC = join(root, 'project', 'Unity Data Stack.dc.html');
...
// add one entry per remote image the unity-data-stack prototype references, then
