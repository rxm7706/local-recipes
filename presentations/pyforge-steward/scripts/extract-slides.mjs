...
// rename this to match (or rename the export to `PyForge Steward.dc.html`).
const SRC = join(root, 'project', 'PyForge Steward.dc.html');
...
// add one entry per remote image the PyForge-Steward prototype references, then
