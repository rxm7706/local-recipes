...
// rename this to match (or rename the export to `PyForge Scribe.dc.html`).
const SRC = join(root, 'project', 'PyForge Scribe.dc.html');
...
// add one entry per remote image the PyForge-Scribe prototype references, then
