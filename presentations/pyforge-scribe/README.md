...
|---|---|---|---|
| `PyForge Scribe Infographic standalone.html` | 144,946 B · 24 sections (23 numbered + creed) · 6 acts · 4 SVG · 9 tables · facts 95/95 | `PENDING-PUSH` (operator pushes via DesignSync after review) | rendered 2026-09-13, page 21684 px; head + Infographic Deck: standalone ahead (lockstep slice pending) |
