...
// rename this to match (or rename the export to `PyForge Marshal.dc.html`).
const SRC = join(root, 'project', 'PyForge Marshal.dc.html');
...
// add one entry per remote image the PyForge-Marshal prototype references, then
