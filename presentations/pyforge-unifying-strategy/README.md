...
etag fabricated. The pre-push gap narrowed to: the head is now re-derived on disk (facts already
...
`1e4020bc-7f7f-43b2-9219-0904d4863df6`, then read back and SHA-256-compared against disk:
