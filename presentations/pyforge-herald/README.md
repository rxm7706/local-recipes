...
|---|---|---|---|
| `PyForge Herald Infographic standalone.html` | 137,557 B · 24 sections (23 numbered + creed) · 6 acts · 4 SVG · 6 tables · facts 53/53 | `PENDING-PUSH` (operator pushes via DesignSync after review) | rendered 2026-09-13, page 17,802 px; head + Infographic Deck: standalone ahead (lockstep slice pending) |
