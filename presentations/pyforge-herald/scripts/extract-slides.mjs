...
// rename this to match (or rename the export to `PyForge Herald.dc.html`).
const SRC = join(root, 'project', 'PyForge Herald.dc.html');
...
// add one entry per remote image the PyForge-Herald prototype references, then
