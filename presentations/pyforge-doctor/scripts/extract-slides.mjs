...
// rename this to match (or rename the export to `PyForge Doctor.dc.html`).
const SRC = join(root, 'project', 'PyForge Doctor.dc.html');
...
// add one entry per remote image the PyForge-Doctor prototype references, then
