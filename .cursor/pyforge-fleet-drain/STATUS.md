...
| Backlog | **marshal 16** · steward **12-7 only** (skipped) — **marshal-only drain** |
...
| Station | Story | PR |
|---------|-------|-----|
| marshal | `22-2` | [#702](https://github.com/rxm7706/local-recipes/pull/702) merge `91c4e5244a` ([Marshal 22-2](f4ff3d89-6bd2-4a8a-bc7a-0a513a591bd7)) · CAP-2 completion judge |
