...
- **`docs/reference/atlas-spec-compendium.md`** — single-file verbatim compilation of every BMAD spec that was used to build cf_atlas (shipped-releases Parts 1–4/7–9 + the three standalone shipped atlas specs), with a spec→version→contribution index. Compilation only — canonical specs stay in `docs/specs/`.
