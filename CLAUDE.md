...
| `docs/specs/cfe-atlas-datapipeline-kedro-migration.md` | Migrate the cf_atlas orchestrator from hand-rolled phases to a Kedro/Dagster/DuckDB stack (Waves 0 + A–H, 22 FRs incl. FR-19 Basilisk vuln source / FR-20 release velocity / FR-21 migration readiness / FR-22 factory layer; v5.6 analysis-complete 2026-07-16). Tier-2 planning underway since 2026-07-17 under BMAD project `conda-forge-atlas-datapipeline` (PRD → architecture → epics → readiness → sprint). Execution via bmad-loop per § 2.5 graduated autonomy. |
