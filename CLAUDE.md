...
| Spec | What it is |
|---|---|
| `docs/specs/cfe-atlas-datapipeline-kedro-migration.md` | cf_atlas orchestrator migrated to a Kedro/Dagster/DuckDB stack — Waves 0 + A–H (22 FRs incl. FR-19 Basilisk / FR-20 release velocity / FR-21 readiness / FR-22 factory layer) executed via bmad-loop under BMAD project `pyforge-atlas`; **PRs #58–#105 MERGED; all 32 stories done, epics 0–9 done** (sprint-status 2026-07-18 15:20Z; only the 8 optional per-epic retrospectives remain) — SHIPPED 2026-07-18 (CFE v8.79.0) **as code + fixture gates**. Attended leftovers remain open: credentialed B4 parity + legacy retirement (DW-B4-*), full 28-page dashboard (DW-D2), F1 cold/warm benchmark (DW-F1-1). Impl-artifact truncation incident reconciled 2026-07-23 (`_bmad-output/projects/pyforge-atlas/_root-fallback-fork-2026-07-19/README.md`); trust only canonical hyphenated files there. |
