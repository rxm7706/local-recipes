...
| `docs/specs/cfe-atlas-datapipeline-kedro-migration.md` | Migrate the cf_atlas orchestrator from hand-rolled phases to a Kedro/Dagster/DuckDB stack (Waves 0 + A–H; v4 2026-07-16 adds FR-19 Basilisk vuln source + FR-20 release velocity). Run via `bmad`. |
