...
| `docs/specs/cfe-atlas-datapipeline-kedro-migration.md` | Migrate the cf_atlas orchestrator from hand-rolled phases to a Kedro/Dagster/DuckDB stack (Waves 0 + A–H, 21 FRs incl. FR-19 Basilisk vuln source / FR-20 release velocity / FR-21 migration readiness; v5.2 reset + corpus sync + domain-research fold 2026-07-16). Run via `bmad`. |
