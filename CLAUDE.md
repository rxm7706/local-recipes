...
| Spec | What it is |
|---|---|
| `docs/specs/cfe-atlas-datapipeline-kedro-migration.md` | cf_atlas orchestrator migrated to a Kedro/Dagster/DuckDB stack — Waves 0 + A–H (22 FRs incl. FR-19 Basilisk / FR-20 release velocity / FR-21 readiness / FR-22 factory layer) executed via bmad-loop under BMAD project `pyforge-atlas`; **PRs #58–#105 MERGED** (sprint-status 2026-07-18: 54 done / 14 review / 6 in-progress) — SHIPPED 2026-07-18 (CFE v8.79.0). Impl-artifact truncation incident reconciled 2026-07-23 (`_bmad-output/projects/pyforge-atlas/_root-fallback-fork-2026-07-19/README.md`); trust only canonical hyphenated files there. |
