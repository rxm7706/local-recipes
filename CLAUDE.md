...
| `docs/specs/cfe-atlas-datapipeline-kedro-migration.md` | Migrate the cf_atlas orchestrator from hand-rolled phases to a Kedro/Dagster/DuckDB stack (Waves 0 + A–H, 22 FRs incl. FR-19 Basilisk vuln source / FR-20 release velocity / FR-21 migration readiness / FR-22 factory layer; v5.5 analysis-complete (reset, corpus sync, research folds, adversarial review, PRFAQ kill-test) 2026-07-16). Run via `bmad`. |
