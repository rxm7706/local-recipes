...
> (G67) → a 1-line langchain-feedstock PR (prepared locally); (2) `langflow-sdk` must bump 0.2.0 → **0.2.1**
> (lfx 1.10.1 requires `>=0.2.1`; #33856). Local green uses a workaround langchain. See § Skew 1 banner.
