...
**🟢 STATUS (2026-06-27): PR [#33972](https://github.com/conda-forge/staged-recipes/pull/33972) is FULLY GREEN — all legs pass (linux + osx + WINDOWS + conda-forge-linter + linter; build 1545234, head `eff237f`).** It is OPEN as a **DRAFT** (branch `rxm7706:langflow-suite-clean`), **not yet merged**.
...
| lfx-docling | [#33978](https://github.com/conda-forge/staged-recipes/pull/33978) | → `lfx`, docling-core |
| lfx-duckduckgo | [#33979](https://github.com/conda-forge/staged-recipes/pull/33979) | → `lfx`, ddgs |
| lfx-ibm | [#33980](https://github.com/conda-forge/staged-recipes/pull/33980) | → `lfx`, langchain-ibm |
| langchain-elasticsearch | [#33981](https://github.com/conda-forge/staged-recipes/pull/33981) | → elasticsearch ≥8.19 (elasticsearch-feedstock #122, external) |
...
| 33 | **langflow-suite** (langflow-sdk + lfx + langflow-base + langflow) | B6 / B8 | [recipe.yaml](https://github.com/rxm7706/local-recipes/blob/main/recipes/langflow-suite/recipe.yaml)          | **SUBMITTED + FULLY GREEN — PR #33972 (DRAFT).** All legs pass (linux + osx + WINDOWS + both linters, build 1545234). Blockers fixed: frontend node-build (G73), gunicorn→run_constraints (G76), magika-0.6.3 win-skew→exclude-0.6.3 (G77); langchain/langflow-sdk/litellm gates cleared (G68); langflow-sdk folded (4th output); #33856 CLOSED. Next: mark ready-for-review. ⚠️ competing PRs #33853/#33875 (pb01ka).                                                                                                                                                                                                       | [#33972](https://github.com/conda-forge/staged-recipes/pull/33972)       |
| 34 | lfx-arxiv                                                          | B7      | [recipe.yaml](https://github.com/rxm7706/local-recipes/blob/main/recipes/lfx-arxiv/recipe.yaml)               | blocked (→lfx)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | [#33977](https://github.com/conda-forge/staged-recipes/pull/33977) |
| 35 | lfx-docling                                                        | B7      | [recipe.yaml](https://github.com/rxm7706/local-recipes/blob/main/recipes/lfx-docling/recipe.yaml)             | blocked (→lfx, docling-core)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | [#33978](https://github.com/conda-forge/staged-recipes/pull/33978) |
...
> to the AGENTS.md contract. This is a status snapshot from 2026-06-26/27 — superseded by
> **§ ⚡ CURRENT STATE (top of this file)**; kept only as historical record.
...
> **2026-08-22 header correction (OCP spec pass):** the header block above is
> historical — the suite merged and graduated to `conda-forge/langflow-feedstock`,
> now **v1.11.4 with 8 outputs** (the 4 `lfx-*` plugins absorbed; see the 2026-08-14
> and 2026-08-20 addenda). The 1.10.1 / PR #33972 framing describes the submission
> era, not the current state.
