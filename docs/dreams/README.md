...
| [`pyforge-unifying-strategy.md`](pyforge-unifying-strategy.md) | specified | Evergreen Canopy Dream. Read **How to read** + Grounding first. CAP-1..18 closeout stands. **CAP-19** / Epic 34 is the live residual. Kedro optional / Vizro Lane 3 / bind-now stack in `stack.md`. Not a sibling Dream. Q5 parked on [`build-league-scorecard.md`](build-league-scorecard.md). |
