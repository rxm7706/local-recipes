...
| [`pyforge-pages.md`](pyforge-pages.md) | archived | The public Pages root is one dossier YAML with many renders — landing, gallery, Claude Artifact — Kedro-Viz stays at `/kedro-viz/`; foundry rebuilds this surface after 54.5. |
