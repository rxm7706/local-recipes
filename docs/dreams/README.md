...
| [`sprint-ledger-query-module.md`](sprint-ledger-query-module.md) | dreamt | Pluggable, extensible, hookable, and feature-flagged Sprint Ledger Query Module, Work Passports identity, Django Admin/HTMX views, and multi-system exporters. |
