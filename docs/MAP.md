...
| [`sync-jira-github-workflow-templates/`](reference/sync-jira-github-workflow-templates/) | True reference | Reusable GitHub Actions workflow templates for Jira↔GitHub Projects sync (see `archive/docs/intake/jira-github-projects-sync/`, archived doctor 23.4) |
