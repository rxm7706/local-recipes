...
_PROJECT_OVERRIDES: dict[str, dict[str, object]] = {
    ...
    "wasm-analytics-stack": {"project_dir": "pyforge-atlas", "epics_path": None, "ledger_path": None},
    "unity-data-stack": {"project_dir": "pyforge-atlas", "epics_path": None, "ledger_path": None},
}
...
def _discovered_board_keys() -> list[str]:
    ...
    return [ep.relative_to(REPO_ROOT / "_bmad-output" / "projects").parts[0].removeprefix("pyforge-")
