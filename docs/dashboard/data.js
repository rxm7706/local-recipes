window.DASHBOARD_DATA = {
  "projects": {
    ...
    "doctor": {
      ...
      "velocity": {
        "derived": true,
        "sub": "Active agent-compute per story (dev + review; excludes gate-pause wait) — derived from this line's bmad-loop journals. 12 of 28 stories measured; the rest predate loop instrumentation and carry wall-clock only (a different metric — see the timing strip), so they are deliberately absent rather than plotted on this axis. A story still in flight contributes only its CLOSED sessions, so its bar is a floor, not a total.",
        "bars": [
          [
            "1.1",
            101
    ...
    "mason": {
      ...
      "timing": {
        ...
        "metric": "active agent-compute per story (dev + review; excludes gate-pause wait) — from bmad-loop run journals",
        "total": 813,
        "totalLabel": "~13.6 h active compute",
  ...
  "snapshot": "<span>2026-08-10 06:19 UTC</span> · source: sprint-status feeds + merged-PR ground truth (#58–#104) + bmad-loop run journals · timing: Warden = active compute (journals), Atlas = wall-clock (PR timestamps)",
  ...
  "status": {
    ...
    "lastShipped": {
      ...
      "epoch": 1786339978,
      "sha": "effe2a312",
      "subject": "Merge bmad-loop/20260809-231524-abb9/4-12-a-landing-leaves-the-loop-home-current-with-main into loop/pyforge-marshal (bm"
    },
    "runningAvailable": false,
    "generatedAt": "2026-08-10 06:19 UTC",
    "generatedEpoch": 1786342744
  },
  "storySpecs": [
    {
  ...
  "readiness": {
    "rows": [
      ...
      },
      {
        ...
        "blocked": 0,
        "total": 46,
        "next": "13-5-downstream-handoff-to-mason",
        "blockedKeys": [],
        "backlogKeys": [
