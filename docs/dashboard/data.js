window.DASHBOARD_DATA = {
  "projects": {
    ...
    "doctor": {
      ...
      "velocity": {
        "derived": true,
        "sub": "Active agent-compute per story (dev + review; excludes gate-pause wait) — derived from this line's bmad-loop journals. 29 of 57 stories measured; the rest predate loop instrumentation and carry wall-clock only (a different metric — see the timing strip), so they are deliberately absent rather than plotted on this axis. A story still in flight contributes only its CLOSED sessions, so its bar is a floor, not a total.",
        "bars": [
          [
            "1.1",
            101
    ...
    "marshal": {
      ...
      "velocity": {
        "derived": true,
        "sub": "Active agent-compute per story (dev + review; excludes gate-pause wait) — derived from this line's bmad-loop journals. 58 of 142 stories measured; the rest predate loop instrumentation and carry wall-clock only (a different metric — see the timing strip), so they are deliberately absent rather than plotted on this axis. A story still in flight contributes only its CLOSED sessions, so its bar is a floor, not a total.",
        "bars": [
          [
            "1.1",
            165
    ...
    "mason": {
      ...
      "inflight": {
        ...
        "lo": 14,
        "hi": 435,
        "phaseAsOf": "2026-08-20 23:03 UTC"
      },
      "velocity": {
        "derived": true,
    ...
    "steward": {
      ...
      "velocity": {
        "derived": true,
        "sub": "Active agent-compute per story (dev + review; excludes gate-pause wait) — derived from this line's bmad-loop journals. 18 of 55 stories measured; the rest predate loop instrumentation and carry wall-clock only (a different metric — see the timing strip), so they are deliberately absent rather than plotted on this axis. A story still in flight contributes only its CLOSED sessions, so its bar is a floor, not a total.",
        "bars": [
          [
            "8.1",
            182
      ...
      "timing": {
        ...
        "metric": "active agent-compute per story (dev + review; excludes gate-pause wait) — from bmad-loop run journals",
        "total": 2803,
        "totalLabel": "~46.7 h active compute",
  ...
  "snapshot": "<span>2026-08-20 23:03 UTC</span> · source: sprint-status feeds + merged-PR ground truth (#58–#104) + bmad-loop run journals · timing: Warden = active compute (journals), Atlas = wall-clock (PR timestamps)",
  ...
  "status": {
    ...
    "generatedAt": "2026-08-20 23:03 UTC",
    "generatedEpoch": 1787267025
  },
  "storySpecs": [
    {
  ...
  "readiness": {
    "rows": [
      ...
      },
      {
        ...
        "blocked": 0,
        "total": 57,
        "next": "10-3-the-drift-surfaces-ambiently-never-gates",
        "blockedKeys": [],
        "backlogKeys": [
          ...
          "12-2-the-exemplar-standard-conformance-table-is-refreshed-and-re-verified",
          "12-3-chain-completeness-parses-capability-ids-not-a-bare-substring-match"
        ],
        "state": "ready"
      },
      {
      ...
      },
      {
        ...
        "blocked": 1,
        "total": 42,
        "next": "6-1-slice-map-and-campaign-state",
        "blockedKeys": [
