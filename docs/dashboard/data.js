window.DASHBOARD_DATA = {
  "projects": {
    ...
    "herald": {
      ...
      "inflight": {
        ...
        "phase": "dev",
        "attempt": "1",
        "startEpoch": 1786659493,
        "median": 169,
        "lo": 29,
        "hi": 539,
        "phaseAsOf": "2026-08-13 23:04 UTC"
      },
      "velocity": {
        "derived": true,
      ...
      "timing": {
        ...
        "metric": "active agent-compute per story (dev + review; excludes gate-pause wait) — from bmad-loop run journals",
        "total": 2468,
        "totalLabel": "~41.1 h active compute",
    ...
    "marshal": {
      ...
      "velocity": {
        "derived": true,
        "sub": "Active agent-compute per story (dev + review; excludes gate-pause wait) — derived from this line's bmad-loop journals. 44 of 126 stories measured; the rest predate loop instrumentation and carry wall-clock only (a different metric — see the timing strip), so they are deliberately absent rather than plotted on this axis. A story still in flight contributes only its CLOSED sessions, so its bar is a floor, not a total.",
        "bars": [
          [
            "1.1",
            165
    ...
    "mason": {
      ...
      "velocity": {
        "derived": true,
        "sub": "Active agent-compute per story (dev + review; excludes gate-pause wait) — derived from this line's bmad-loop journals. 20 of 42 stories measured; the rest predate loop instrumentation and carry wall-clock only (a different metric — see the timing strip), so they are deliberately absent rather than plotted on this axis. A story still in flight contributes only its CLOSED sessions, so its bar is a floor, not a total.",
        "bars": [
          [
            "1.2",
            91
      ...
      "timing": {
        ...
        "metric": "active agent-compute per story (dev + review; excludes gate-pause wait) — from bmad-loop run journals",
        "total": 2655,
        "totalLabel": "~44.2 h active compute",
    ...
    "steward": {
      ...
      "inflight": {
        "key": "8.6",
        "title": "Explicit status-vocabulary translation",
        "phase": "dev",
        "attempt": "1",
        "startEpoch": 1786661584,
        "median": 147,
        "lo": 44,
        "hi": 468,
        "phaseAsOf": "2026-08-13 23:04 UTC"
      ...
      "velocity": {
        "derived": true,
        "sub": "Active agent-compute per story (dev + review; excludes gate-pause wait) — derived from this line's bmad-loop journals. 12 of 41 stories measured; the rest predate loop instrumentation and carry wall-clock only (a different metric — see the timing strip), so they are deliberately absent rather than plotted on this axis. A story still in flight contributes only its CLOSED sessions, so its bar is a floor, not a total.",
        "bars": [
          [
            "8.1",
            286
      ...
      "timing": {
        ...
        "metric": "active agent-compute per story (dev + review; excludes gate-pause wait) — from bmad-loop run journals",
        "total": 2141,
        "totalLabel": "~35.7 h active compute",
  ...
  "snapshot": "<span>2026-08-13 23:04 UTC</span> · source: sprint-status feeds + merged-PR ground truth (#58–#104) + bmad-loop run journals · timing: Warden = active compute (journals), Atlas = wall-clock (PR timestamps)",
  ...
  "status": {
    ...
    "lastShipped": {
      ...
      "epoch": 1786659926,
      "sha": "d34ce6193",
      "subject": "Merge bmad-loop/20260813-160412-936a/8-4-the-schedule-trigger-enumerates-real-candidates into loop/pyforge-steward (bmad"
    },
    "runningAvailable": true,
    "generatedAt": "2026-08-13 23:04 UTC",
    "generatedEpoch": 1786662276
  },
  "storySpecs": [
    {
  ...
  "readiness": {
    "rows": [
      ...
      },
      {
        ...
        "blocked": 0,
        "total": 41,
        "next": "8-6-explicit-status-vocabulary-translation",
        "blockedKeys": [],
        "backlogKeys": [
