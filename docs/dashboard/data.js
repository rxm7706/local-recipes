window.DASHBOARD_DATA = {
  "projects": {
    ...
    "doctor": {
      ...
      "inflight": {
        "key": "7.3",
        "title": "The detector sees anonymous Tier-3 entries",
        "phase": "dev",
        "attempt": "1",
        "startEpoch": 1786634807,
        "median": 112,
        "lo": 34,
        "hi": 427,
        "phaseAsOf": "2026-08-13 15:42 UTC"
      },
      "velocity": {
        "derived": true,
      ...
      "timing": {
        ...
        "total": 2848,
        "totalLabel": "~47.5 h active compute",
    ...
    "herald": {
      ...
      "timing": {
        ...
        "metric": "active agent-compute per story (dev + review; excludes gate-pause wait) — from bmad-loop run journals",
        "total": 2093,
        "totalLabel": "~34.9 h active compute",
    ...
    "marshal": {
      ...
      "inflight": {
        "key": "3.11",
        "title": "A story's declared difficulty actually picks its model *(added 2026-08-11 — FR-182)*",
        "phase": "dev",
        "attempt": "1",
        "startEpoch": 1786634904,
        "median": 107,
        "lo": 27,
        "hi": 486,
        "phaseAsOf": "2026-08-13 15:42 UTC"
      ...
      "timing": {
        ...
        "metric": "active agent-compute per story (dev + review; excludes gate-pause wait) — from bmad-loop run journals",
        "total": 5569,
        "totalLabel": "~92.8 h active compute",
  ...
  "snapshot": "<span>2026-08-13 15:42 UTC</span> · source: sprint-status feeds + merged-PR ground truth (#58–#104) + bmad-loop run journals · timing: Warden = active compute (journals), Atlas = wall-clock (PR timestamps)",
  ...
  "status": {
    ...
    "generatedAt": "2026-08-13 15:42 UTC",
    "generatedEpoch": 1786635761
  },
  "storySpecs": [
    {
