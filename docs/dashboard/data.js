window.DASHBOARD_DATA = {
  "projects": {
    ...
    "marshal": {
      ...
      "timing": {
        ...
        "metric": "active agent-compute per story (dev + review; excludes gate-pause wait) — from bmad-loop run journals",
        "total": 3281,
        "totalLabel": "~54.7 h active compute",
    ...
    "mason": {
      ...
      "timing": {
        ...
        "metric": "active agent-compute per story (dev + review; excludes gate-pause wait) — from bmad-loop run journals",
        "total": 784,
        "totalLabel": "~13.1 h active compute",
        "note": "Derived from 9 measured stories; a story still in flight contributes only its closed sessions.",
        "perStory": {
          "1.2": 91,
          "1.3": 402,
          "1.4": 36,
  ...
  "snapshot": "<span>2026-08-10 05:35 UTC</span> · source: sprint-status feeds + merged-PR ground truth (#58–#104) + bmad-loop run journals · timing: Warden = active compute (journals), Atlas = wall-clock (PR timestamps)",
  ...
  "status": {
    ...
    "lastShipped": {
      ...
      "epoch": 1786331528,
      "sha": "181db8e0a",
      "subject": "Merge bmad-loop/20260809-195207-7471/6-8-bmad-drift-comes-home-without-breaking-the-board into loop/pyforge-doctor (bmad"
    },
    "runningAvailable": false,
    "generatedAt": "2026-08-10 05:35 UTC",
    "generatedEpoch": 1786340150
  },
  "storySpecs": [
    {
  ...
  "readiness": {
    "rows": [
      ...
      },
      {
        ...
        "blocked": 0,
        "total": 46,
        "next": "13-4-fixed-source-audit-track",
        "blockedKeys": [],
        "backlogKeys": [
