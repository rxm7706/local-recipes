...
| **LC-2** | Frame registry | Realized 2026-09-15 on `spec-self-hosted-bmad-marketplace` CAP-7 / steward Epic 60 (git listings + same ship backends; not nebari-frames) | no fourth infra kind |
