...
**Commands:**
- `pixi run -e platform-ci-test pytest tests/test_front_door_queries_supervisor.py tests/test_supervisor_tables.py tests/test_start_get_survives_disconnect.py tests/meta/test_no_pyforge_import.py -q` — expected: all passed (cwd `src/platform`)
