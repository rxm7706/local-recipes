...
| P16 | No loop running at the flip; 8 homes re-provisioned attended | `fnd:AD-12`, `fnd:AD-17`; 44.12 | mechanism = 44.12 (not built); readiness undefined | marshal 31.5 defines; steward 44.12 builds |
...
| G4 | Rulebooks unclassified for the move (neither Dream, memlog, nor narrative) | fnd:AD-20 buckets | marshal 30.2 (they retire) |
...
| G11 | `frozen-path-changed` detector named by fnd:AD-22/fnd:AD-11, never built | cutover spine :159,225 | doctor 20.3 |
