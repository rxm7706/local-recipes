...
| Lane 2 portals at `/stations/{station}/` | Warden's mounts at `/compliance/` | The URL shape is an **open design point**, not settled. Whatever CAP-3 picks, `compliance_face` has to move or the scheme has to accommodate it |
