...
```
_bmad-output/projects/pyforge-doctor/
├── planning-artifacts/
...
- **Tier 0 (Dream)**: `docs/dreams/pyforge-doctor*.md`
- **Tier 2 (Planning)**: `_bmad-output/projects/pyforge-doctor/planning-artifacts/`
- **Tier 3 (Execution)**: `_bmad-output/projects/pyforge-doctor/implementation-artifacts/` (gitignored)
...
1. Read the Dream (`docs/dreams/pyforge-doctor*.md`) to understand the vision
