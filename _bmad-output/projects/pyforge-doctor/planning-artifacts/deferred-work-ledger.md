...
- source_spec: `_bmad-output/projects/pyforge-doctor/planning-artifacts/specs/spec-deferred-work-visibility/SPEC.md`
  ...
  closed: 2026-08-21 — Story 12.3 (spec-12-3-chain-completeness-parses-capability-ids-not-a-bare-substring-match) landed: board.py::_check_project_chain_completeness now parses declared CAP-N ids and reports the specific uncovered ones instead of a bare substring test.
