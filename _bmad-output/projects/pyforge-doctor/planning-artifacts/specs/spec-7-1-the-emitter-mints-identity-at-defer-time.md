...
- Confirmed live measurements behind three findings: worktree ledger 16,149 B vs shared 28,329 B
  ...
  missing final component; 0 letter-suffixed story keys exist across the fleet (the marshal:AD-38 shape is
  latent, not live).
