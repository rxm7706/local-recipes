...
- Rejected — false (1): claimed stale ledger/epics `backlog` status risks duplicate re-dispatch; refuted — ledger/epics promotion is owned by the separate landing process (CAP-261), never by this dev/review workflow.
