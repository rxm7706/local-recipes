...
# The planning-workflow scratch document that was `epics.md` until 2026-08-08. Retained
# because it is the real record of how Epics 6-12 were shaped ("REQUIREMENTS EXTRACTED &
# VERIFIED", "APPROVED EPIC STRUCTURE (Step 2 Complete)"), and because the new canonical
# epics.md cites it. It listed stories as BULLETS rather than `### Story` headings and
# covered only Epics 6-12, so it declared zero stories in the fleet-standard shape
# against a 47-story ledger — the failure INV-D now catches. Feeds NO ledger key.
---
