...
**Summary:** landed on `main` as `5d9e598c2c` (2026-08-15, "Story 10.1: bmad-method-version-drift Source (CAP-1)"); also `b5976d4a41` (2026-08-08, "herald: Story specs 10.1-10.6 (Epic 10, Operations Notices)"); also `d50fa325b1` (2026-08-08, "herald: Story 10.1/10.3/10.6 — notice storage, redirects, lifecycle"). Ledger row `10-1-notice-data-model-archive-storage: done`.
