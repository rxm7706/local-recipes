...
Ledger key: `23-8-one-command-idempotent-reported`.
Minted 2026-09-16 from `epics.md` so `marshal factory dispatch` can resolve `spec-23-8-one-command-idempotent-reported.md`.
