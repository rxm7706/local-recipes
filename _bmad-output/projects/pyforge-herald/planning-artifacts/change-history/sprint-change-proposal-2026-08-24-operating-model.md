...
status: approved
created: '2026-08-24'
scope: pyforge-unifying-strategy operating-model Q1–Q8 — pyforge-herald (planning-only)
approach: Direct Adjustment
---

# Sprint Change Proposal — Operating-model obligations (pyforge-herald)
...
**Herald-local:** Deck/export format plugins (Marp, PPTX, .dc.html) are station hooks. Publish/export success is not a Warden verdict. Lane 1 CMS remains steward-owned.
