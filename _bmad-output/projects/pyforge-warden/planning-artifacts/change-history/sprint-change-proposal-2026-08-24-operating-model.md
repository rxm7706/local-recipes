...
status: approved
created: '2026-08-24'
scope: pyforge-unifying-strategy operating-model Q1–Q8 — pyforge-warden (planning-only)
approach: Direct Adjustment
---

# Sprint Change Proposal — Operating-model obligations (pyforge-warden)
...
and `DW-OM-2026-08-24` to the deferred-work ledger.

**Superseded later the same day:** “No new station epic / record only” is retracted by
`sprint-change-proposal-2026-08-24-hook-specs.md` (Warden **Epic 9**).
...
**Warden-local:** This station **owns the PR-gate hook specifications** (Kedro-framework role). Scanner plugins (Sonar, Checkmarx, Black Duck, GHAS, profile-local) implement those hooks. A missing named scanner is not a failed Warden run.

**Superseded later the same day:** hook-spec implementation is Warden Epic 9 (`sprint-change-proposal-2026-08-24-hook-specs.md`). The “record only / no epic” sentence no longer holds.
