...
updated: '2026-09-17'   # 2026-09-14 chain-currency sweep cascade (arch->epics edge); validation note appended, no epic or story restructured
...
Station Spec spec-pyforge-warden reminted absorbed capabilities as CAP-1..22. Historical stories keep their sequential epic numbers (already 1..12 with no gaps). This heading is the INV-A citation window: `spec-pyforge-warden` CAP-1..22.

No blocked ledger keys flipped.
