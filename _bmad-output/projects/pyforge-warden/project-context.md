...
project_phase: 'shipped-core'  # original 31-story core shipped; residual backlog remains
user_name: 'rxm7706'
date: '2026-08-24'
...
_Critical rules and patterns for Compliance Gate & Project Orchestration. Ledger: mostly done (re-ground 2026-08-24)._

**Status:** sprint-status-ledger — **96** done · **4** backlog · **4** optional (incl. epics); **core shipped**, residual backlog (do not treat as zero-work).
