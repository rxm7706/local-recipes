...
```
_bmad-output/projects/pyforge-scribe/
├── planning-artifacts/
...
- **Tier 0 (Dream)**: `docs/dreams/pyforge-scribe*.md`
- **Tier 2 (Planning)**: `_bmad-output/projects/pyforge-scribe/planning-artifacts/`
- **Tier 3 (Execution)**: `_bmad-output/projects/pyforge-scribe/implementation-artifacts/` (gitignored)
...
1. Read the Dream (`docs/dreams/pyforge-scribe*.md`) to understand the vision
