...
**Status (2026-09-13):** `spec-scribe-marshal-fact-visibility` + Story 9.1
(scoped recall admits `presentations/<slug>/facts.yaml`). Parked CAP-6–CAP-9
and CAP-11–CAP-14 stay in `spec-scribe-knowledge-layers/later-caps.md`
(CAP-10 hoisted). Prior note kept below.
