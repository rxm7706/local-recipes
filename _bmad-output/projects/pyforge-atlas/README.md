...
atlas is a Intelligence Mapper station in the PyForge factory, responsible for mapping the Python ecosystem, discovering risks, establishing the foundation for the factory.
...
- **Tier 0 (Dream)**: `docs/dreams/pyforge-atlas*.md`
- **Tier 2 (Planning)**: `_bmad-output/projects/pyforge-atlas/planning-artifacts/`
- **Tier 3 (Execution)**: `_bmad-output/projects/pyforge-atlas/implementation-artifacts/` (gitignored)
...
1. Read the Dream (`docs/dreams/pyforge-atlas*.md`) to understand the vision
...
# Coverage report
pytest tests/ --cov=src/pyforge_atlas --cov-report=html
```
