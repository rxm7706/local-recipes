...
**Summary:** landed on `main` as `95f1db76aa` (2026-08-13, "Merge branch 'bmad-loop/20260813-094919-bfcb/9-1-findings-model-severity-types-remedies' into bmad-loop/202608"). Ledger row `9-1-scaffold-the-karpathy-wiki-folder-structure-and-agent-personas: done`.
...
- frontmatter `status` `shipped` → `done` (ledger row `9-1-scaffold-the-karpathy-wiki-folder-structure-and-agent-personas: done`).
