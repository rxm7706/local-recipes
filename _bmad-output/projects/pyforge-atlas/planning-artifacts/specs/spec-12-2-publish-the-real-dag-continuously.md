...
**Never:**
- No changes to `docs/dashboard/generate.py` or `docs/dashboard/index.html` (Steward-owned; Epic 2 is closed) and no changes to `dashboard.yml` (it already republishes the whole tree unconditionally).
