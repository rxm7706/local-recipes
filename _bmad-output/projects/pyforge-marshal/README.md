...
```
_bmad-output/projects/pyforge-marshal/
├── planning-artifacts/
...
- **Tier 0 (Dream)**: `docs/dreams/pyforge-marshal*.md`
- **Tier 2 (Planning)**: `_bmad-output/projects/pyforge-marshal/planning-artifacts/`
- **Tier 3 (Execution)**: `_bmad-output/projects/pyforge-marshal/implementation-artifacts/` (gitignored)
...
1. Read the Dream (`docs/dreams/pyforge-marshal*.md`) to understand the vision
