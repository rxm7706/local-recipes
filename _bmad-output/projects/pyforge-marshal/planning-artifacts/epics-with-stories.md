---
title: "pyforge-marshal — Complete Epics & Stories (Ready for Development)"
...
**See also:**
- `epics.md` — Complete epic breakdown with FR/AD coverage map
- `test-architecture.md` — Test strategy for all 50 stories
