...
- great-expectations version-capped at conda-forge 1.18.2 on py3.14 (corrected same-day); pandera + openlineage verified compatible → pandera-first FR-10 with GX as the capped boundary layer (§ Technical Trends).
