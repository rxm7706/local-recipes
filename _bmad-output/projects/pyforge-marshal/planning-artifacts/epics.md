...
| **Total** | | | **122** | **~119 days ≈ 24 weeks single-builder (E1-E12 figure; see note)** |
...
`sprint-status-ledger.yaml` pending its next sync) bring E2 to 8, E5 to 9, E1-E6 to 63, and
the total to **122**; the ledger will re-agree on its next sync.*
