...
**Results (against `baseline_revision`, review pass 2 — after the `bad_spec` re-derivation extending Surface to `spec_difficulty.py`/`dispatch_harness_done.py`):**
- `pixi run --frozen -e pyforge-marshal pyforge-marshal-test` — PASS: 8110 passed, 1 skipped, 12 deselected.
