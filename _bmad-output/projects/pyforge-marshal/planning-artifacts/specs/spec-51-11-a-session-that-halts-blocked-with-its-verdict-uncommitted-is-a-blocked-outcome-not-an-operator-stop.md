...
**Verification:** `pixi run --frozen -e pyforge-marshal pyforge-marshal-test` — 8323 passed, 1 skipped, 12 deselected. `pixi run --frozen -e pyforge-ci pyforge-deps-test` — 130 passed, 3 skipped. Both exit 0, read directly (never through a pipe).
