...
Companion to `SPEC.md`. The kernel's Constraints declare the five classes, the
classification rule, and the never-write set as the normative contract; this file holds
the **V1 inventory** — which artifact sits in which class, and why. It is the reference
...
Marker grammar (per AD-03 in the kernel):
