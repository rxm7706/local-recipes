...
**Summary:** landed on `main` as `ca254233ed` (2026-08-14, "Merge branch 'bmad-loop/20260813-094917-9bba/6-11-the-classifier-recognizes-a-spike-report' into land/doctor-6"); also `a747a34867` (2026-08-07, "Merge pull request #289 from rxm7706/marshal/6-1-profile-driven-adapter-selection"). Ledger row `6-1-profile-driven-adapter-selection-project-scoped: done`.
