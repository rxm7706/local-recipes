...
| Source pin (for this doc set) | conda-forge-expert skill v8.40.0 |
...
- `_bmad-output/projects/local-recipes/project-context.md` — foundational rules every BMAD agent reads on spawn (v8.40.0-pinned)
