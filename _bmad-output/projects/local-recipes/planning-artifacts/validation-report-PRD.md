...
overall_verdict: APPROVED (re-validated 2026-05-15 post v8.1.0 sync; pin moved through v8.5.1 / v8.5.2 / v8.5.3 as PATCH bumps + v8.6.0 as MINOR additive bump with D2/D7/D9/D10 spot-check — see verdict_history)
status: final
