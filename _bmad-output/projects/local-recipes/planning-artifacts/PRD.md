...
|---|---|
| Pixi monorepo scaffolding (17 envs / 17 features, 154 tasks — 106 in the `local-recipes` feature) | The ~1,660 recipes under `recipes/` |
...
| F5.4 | Six lean `no-default-feature` product envs | P0 | `pyforge-{warden,atlas,doctor,scribe,herald}` + `bmad-ui` resolve independently of the 9 factory envs (17 envs / 17 features total) |
