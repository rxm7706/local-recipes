...
│   │   ├── SKILL.md                         # ★ primary spine: critical constraints, 10-step loop, gotchas G1-G51
...
| Skill version (source_pin) | conda-forge-expert v8.40.0 |
...
- MCP tools 35 → 42; cf_atlas schema v25 → v28; skill v8.11.1 → v8.39.0.
