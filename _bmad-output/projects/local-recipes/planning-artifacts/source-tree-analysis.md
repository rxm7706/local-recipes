...
│   │   ├── SKILL.md                         # ★ primary spine: critical constraints, 10-step loop, gotchas G1–G53
...
| Skill version (source_pin) | conda-forge-expert v8.41.0 |
...
- Skill v8.39.0 → v8.41.0 (MINOR, additive). Recipe-Authoring Gotchas G1–G53 → G1–G53 (+G46–G53 feedstock-refresh build-shape gotchas). No source-tree structural change: CFE scripts/wrappers/tests, atlas phases (22), schema (v28), MCP tools (42), `reference/` (17), `guides/` (9) all unchanged — v8.41.0 is SKILL.md + guide prose only.
