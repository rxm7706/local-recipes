...
- **Skill version:** v8.78.0 (re-synced 2026-07-16)
...
9. **11 pixi envs** — `linux`, `osx`, `win`, `build`, `grayskull`, `conda-smithy`, `local-recipes` (default), `vuln-db`, `gcloud`, plus the standalone no-default-feature `pyforge-warden` and `bmad-ui`.
