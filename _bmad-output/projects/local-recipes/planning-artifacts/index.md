...
- **Skill version:** v8.52.1 (re-synced 2026-06-27)
...
| 3 | [architecture-conda-forge-expert.md](./architecture-conda-forge-expert.md) | Part 1: 3-tier scripts/wrappers/data architecture, 10-step autonomous loop, 42 Tier 1 scripts, 41 templates / 13 ecosystems, build failure protocol, Recipe Authoring Gotchas G1–G75 |
...
|---|---|---|---|
| This doc set | v8.52.1 | conda-forge-expert v8.52.1 | None needed — reconciled this session |
| project-context.md | v8.11.1 | v8.52.1 (skill) | Re-verify on next MINOR-bump sweep: § Recipe Format / MCP Lifecycle / Anti-Patterns / Gotchas (G1–G75) |
