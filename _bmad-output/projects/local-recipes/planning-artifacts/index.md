...
- **Default pixi env:** `local-recipes` (11 envs total)
...
- [`pixi.toml`](../../../../pixi.toml) — 11 envs, ~80 pixi tasks, build features
...
| project-context.md | v8.11.1 | v8.62.0 (skill) | Re-verify on next MINOR-bump sweep: § Recipe Format / MCP Lifecycle / Anti-Patterns / Gotchas (G1–G106) |
