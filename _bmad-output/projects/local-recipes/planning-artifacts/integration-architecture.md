...
Plus the cross-cutting items (18 pixi envs in two families, env-var inheritance, permission gates, CI gates, spec-surface governance) are setup conditions, not contracts per se, but the rebuild must establish them before any part can function.
