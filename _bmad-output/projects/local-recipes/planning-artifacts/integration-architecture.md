...
**Project-context drift pin**: `_bmad-output/projects/local-recipes/project-context.md` frontmatter `last_synced_skill_version` pins to a MINOR (currently `v7.7`). When Part 1's CHANGELOG ships a new MINOR, the pin signals re-sync needed.
