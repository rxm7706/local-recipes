...
status: approved
created: '2026-08-24'
scope: pyforge-unifying-strategy operating-model Q1–Q8 — pyforge-mason (planning-only)
approach: Direct Adjustment
---

# Sprint Change Proposal — Operating-model obligations (pyforge-mason)
...
**Mason-local:** Build-engine variants (rattler-build, conda-build, sandboxes) are **station hook plugins**, not CI quality gates. A green Mason build is not a Warden verdict. Do not mint a portal/MCP/persona for 01 recipe experiments.
