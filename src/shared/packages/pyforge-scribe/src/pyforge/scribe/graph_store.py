...
output (Story 2.2's idempotency requirement). The temp-file-then-replace
write itself delegates to `pyforge.core.atomic_write_text` (Story 14.2,
CAP-2 -- the one shared primitive; this file no longer hand-rolls it).
