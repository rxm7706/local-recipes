...
def test_restore_is_fourteenth_duty():
    ...
    assert len(DUTIES) == 24  # noqa: PLR2004 -- + `cutover` (Story 44.12) + `ledger-query` (Story 65.1) + `catalog` (Story 60.1) + `load` (Story 61.1) + passport (Story 61.2) + glass (Story 61.3) + session (Story 63.4)
