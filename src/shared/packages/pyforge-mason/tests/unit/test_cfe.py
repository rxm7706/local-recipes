...
from pyforge.mason.cfe import (
    ...
    generate_recipe, probe_import_floor, run_streamed, submit_pr, validate_recipe,
)
...
def test_cfe_scripts_table_has_exactly_the_two_story_1_9_fixture_entries():
    ...
    `generate_recipe` -- Story 1.9's and Story 2.4's fixtures stub exactly
    these three scripts, and which script backs each of Stories 2.5-2.10 is
    still open."""
    assert _CFE_SCRIPTS == {
