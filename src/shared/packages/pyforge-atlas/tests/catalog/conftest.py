...
EXPECTED_PIPELINE_COUNTS = {
    ...
    "seed_gaps": 8,
    "derived_artifacts": 4,  # Story 23.8: + inventory_universe; Story 23.3: + inventory_priority_assignments
...
EXPECTED_TOTAL = 122  # Story 23.3: +2 (vulnerability_basilisk_rollup + inventory_priority_assignments)
