...
stub only makes the ``deptry-scanner`` console script resolvable so the package
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "deptry-scanner: Option B build skeleton wired. "
        "E1-E4 not yet implemented - see docs/specs/deptry-scanner.md.",
        file=sys.stderr,
    )
    return 0
