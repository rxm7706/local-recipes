...
(Story 13.1, DW-1-4-2) joins for the same reason once more: a stdlib-only
advisory file lock shared by ``state``/``progress``/``claims``/``notices``,
with no transport call and no inference SDK of its own."""
