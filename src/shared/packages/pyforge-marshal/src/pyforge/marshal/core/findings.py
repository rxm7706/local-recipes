...
evaluated at all -- no active/resolvable project, no ``--story``, an
unresolvable story key, or a ``VcsPort`` failure resolving the worktree's
changed files). ``MRS-GATE-007``/``008`` classify ``Verdict.
