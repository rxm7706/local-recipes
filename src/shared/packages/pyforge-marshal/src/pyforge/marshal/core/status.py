...
def is_run_live(facts: FleetHomeFacts) -> bool:
    """Pure liveness predicate (Story 4.11, FR-... "marshal land refuses
    while a run is in flight"): ``True`` when a bmad-loop supervisor/engine
    run for this project is still using its own station branch -- the ONE
