...
def test_registered_codes_contains_the_real_codes():
    ...
    completions adds MRS-DEPLOY-024/025/026 (the tracked ledger unreadable,
    its write path failed, and a corroborated quick-dev key absent from
    the ledger). This asserts the registry's exact real contents."""
