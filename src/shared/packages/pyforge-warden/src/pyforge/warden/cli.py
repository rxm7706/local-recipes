...
def _run_scan(args: argparse.Namespace) -> int:
    ...
    # kev_data/vuln_data already use -- CurrencyEngine always populates
    # currency_data (the bundled registry is consulted unconditionally, no
    # gating flag disables it); every other engine/path leaves it None.
    currency_data = next(
        (
