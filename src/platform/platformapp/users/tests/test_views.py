...
from platformapp.users.views import UserRedirectView
from platformapp.users.views import UserUpdateView
from platformapp.users.views import user_detail_view
